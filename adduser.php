<?php
   ...
   if (isset($_POST['active'])) {
    ...
    $sql = "insert into users(username,passcode,popis,active,admin,email,telefon,vlozil,datum) values('".$_POST['username']."','".$_POST['passcode']."','".$_POST['popis']."',".$active.",".$admin.",'".$_POST['email']."','".$_POST['telefon']."','".$_SESSION['login_user']."',now())";
    if ($_SESSION['admin'] == 1) {
...
<html>  
   ...
   <body>   
	  ...
	  <h2 align="center">Uživatelé / Users / Benutzer </h2>
	   ...
	   echo "<tr style='background-color: #e0e0eb'><td>login</td><td>note</td><td>active</td><td>admin</td><td>Phone</td><td>Email</td><td>del</td><td>pwd</td></tr>";
   
	
		$sql = "SELECT id, username, active, admin, email, telefon, popis FROM users order by username";
		$result = $db->query($sql);
		if ($result->num_rows > 0) {
			while($row = $result->fetch_assoc()) {
				...
				echo "</td><td><a href='userpwd.php?id=".$row["id"]."'><img src='img/edit16.png' title='Heslo/Password/Passwort'></a></td></<tr>";
				}	
		}
	?> 
	</table>
         ...
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "post">
                  ...
                  <label>Heslo  :</label><input type = "text" name = "passcode" class = "box" /><br /><br />
                  <label>Popis  :</label><input type = "text" name = "popis" class = "box" /><br /><br />
                  <label>Active :</label><input type = "checkbox" name = "active" class = "box" checked /><br /><br />
                  <label>Admin :</label><input type = "checkbox" name = "admin" class = "box" /><br /><br />
